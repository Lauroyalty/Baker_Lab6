...
function Level(plan) {
  ...
  for (var y = 0; y < this.height; y++) {
	...
	//enter y
	  if (ch == "y")
		fieldType = "floater";
      // "Push" the fieldType, which is a string, onto the gridLine array 
...
// A Player has a size, speed and position. Change size
function Player(pos) {
  this.pos = pos.plus(new Vector(0, -0.5));
  //placement of character on border
  this.size = new Vector(2.0, 1.0);
...
DOMDisplay.prototype.scrollPlayerIntoView = function() {
  ...
  var center = player.pos.plus(player.size.times(1.0))
                 .times(scale);
...
var wobbleESpeed = .5, wobbleEDist = 5;
...
if(!audioElement) {
  ...
  audioElement.innerHTML = '<source src="http://www.flashkit.com/imagesvr_ce/flashkit/soundfx/Cartoon/skd-skd-8606/skd-skd-8606_hifi.mp3"' + "/audio/sound.mp3"+ '" type="audio/mpeg" />'
}
     audioElement.play();
     return other != actor;
    });
